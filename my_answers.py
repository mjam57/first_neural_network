...
#        print("X", X.shape)
#        print("weights i to h", self.weights_input_to_hidden.shape)
#        hidden_inputs = np.dot(self.weights_input_to_hidden, X) # signals into hidden layer
        ...
        ###This is given in the neural network spec above
...
#        print("x", X.shape)
        ...
        ###the activation function of the output node is given as f(x) = x. Derivative is 1.0
#        print("output error term", output_error_term.shape)
#        print("weights h to o", self.weights_hidden_to_output.shape)
